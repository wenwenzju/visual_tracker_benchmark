...
int main(int argc, char** argv)
{
	...
	try
	{
		...
		PTUsingReIdandPF tracker(5, particles, use_optical_flow_lk, update_online, learning_rate, sigmax, sigmay, sigmaw, exp_coeff_re_id, re_id_weight, hog_particle_expand, thread_num, aspect_ratio, rwr, cur_probe);
