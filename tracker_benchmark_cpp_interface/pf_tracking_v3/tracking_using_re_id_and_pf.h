...
private:
	...
	////////////////////////////////////new added linear combination of each particle template
	//Eigen::MatrixXd H_;
	std::vector<pe_re_id::SdalfFeature> par_fea_;
	std::vector<vec_d > ptcs_;
	void calc_template_(std::vector<pe_re_id::SdalfFeature>& pf, std::vector<vec_d >& pt, vec_d& gt, pe_re_id::SdalfFeature& tpl);
